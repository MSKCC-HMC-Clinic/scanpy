...
def test_gene_ranking_normalization():
    ...
    # normalization_types = ["by_total_transition_probability", "by_number_cells", "L1", "L2", "log", "mean", "min_max_feature_scaling"]
    # normalization_types = ["log"]

    normalization_types = ["mean", "min_max_feature_scaling"]
